...
export default function Header() {
  ...
  return (
    <header className="bg-inherit absolute top-0 left-1/2 transform -translate-x-1/2 md:static md:transform-none flex flex-col items-center space-y-5 md:flex-row md:justify-between w-full px-4">
      <div>
        <Link href="/home">
          <Image
            src={logo}
