  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-auto">
        <ul className="flex flex-col justify-center items-center md:flex-row space-y-2 md:space-y-0 md:space-x-10 text-sm md:text-base font-extralight md:font-light">
