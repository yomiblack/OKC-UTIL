...
export default function Header() {
  ...
  // Ensure the header has a transparent background to match the page
  const headerStyle = {
    backgroundColor: "transparent",
  };
  return (
    <nav className="absolute top-0 left-1/2 transform -translate-x-1/2 md:static md:transform-none flex flex-col items-center space-y-5 md:flex-row md:justify-between w-full px-4 bg-transparent">
      <div>
        <Link href="/home">
          <Image
            src={logo}
      ...
      <div>
        <ul className="flex flex-col justify-center items-center md:flex-row space-y-2 md:space-y-0 md:space-x-10">
