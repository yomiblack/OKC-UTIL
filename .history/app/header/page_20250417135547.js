...
export default function Header() {
  ...
  return (
    <header
      className={`${domine.className} bg-white absolute top-0 left-1/2 md:left-0 transform -translate-x-1/2  md:transform-none flex flex-col items-center space-y-5 md:flex-row md:justify-between w-full px-4 py-2`}
    >
      <div>
        <Link href="/home">
          <Image
