...
export default function Header() {
  ...
  return (
    <header className="absolute flex flex-col items-center justify-center space-y-5 md:flex-row md:justify-between md:items-center space-x-20">
      ...
      <nav>
        <ul className="flex flex-col md:flex-row justify-between items-center space-y-2">
