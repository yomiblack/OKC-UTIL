...
export default function Header() {
  ...
  return (
    <header
      className={`${domine.className} opacity-100  relative md:fixed top-0 w-full px-4 py-2 flex flex-col justify-center items-center space-y-5 md:flex-row md:justify-between md:space-y-0 shadow-md dark:shadow-slate-800 shadow-gray-100 z-10`}
    >
      <div className="">
