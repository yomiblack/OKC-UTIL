...
export default function Header() {
  ...
  return (
    <header
      className={`${domine.className} bg-slate-900 relative md:fixed top-0 left-0 w-full px-4 py-2 flex flex-col items-center space-y-5 md:flex-row md:justify-between md:items-center border-b-2 border-slate-800 z-10`}
    >
