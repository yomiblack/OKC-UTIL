...
export default function Header() {
  ...
  return (
    <nav className="absolute top-0 left-1/2 md:left-0 transform -translate-x-1/2  md:transform-none flex flex-col items-center space-y-5 md:flex-row md:justify-between w-full px-4 py-2">
      <div>
        <Link href="/home">
          <Image
            src={logo}
      ...
      <div>
        <ul className="flex flex-col justify-center items-center md:flex-row space-y-2 md:space-y-0 md:space-x-10 text-sm md:text-base font-extralight md:font-medium font-domine">
