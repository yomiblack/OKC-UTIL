...
export default function Header() {
  ...
  return (
    <header
      className={`${domine.className} bg-slate-900 relative md:fixed top-0 w-full px-4 py-2 flex flex-col justify-center items-center space-y-5 md:flex-row md:justify-between md:space-y-0 shadow-md shadow-slate-800 z-10`}
    >
      <div className="">
      ...
      <div className="w-full md:w-auto">
        <ul className="flex flex-col justify-center items-center md:flex-row space-y-2 md:space-y-0 md:space-x-10 md:justify-end text-sm md:text-base font-extralight md:font-light">
