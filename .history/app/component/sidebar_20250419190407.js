    ...
    <aside className="">
      ...
      <div className="mb-6">
        <input
          ...
          className="bg-transparent placeholder w-full p-3 outline-none focus:outline-none focus:shadow-inner hover:shadow-md hover:shadow-orange-300 transition-all duration-200 focus:shadow-orange-300   rounded-md  dark:text-stone-50 text-stone-700 shadow-sm shadow-orange-200"
        />
      </div>
