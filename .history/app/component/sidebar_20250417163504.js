    ...
    <aside className="hidden relative md:fixed left-0 md:block border-r-2 dark:border-slate-800 border-slate-100 text-sm min-h-dvh p-4 max-w-sm ">
      ...
      <div className="mb-6">
        <input
          ...
          className="bg-transparent w-full p-3 border outline-none focus:outline-none focus:ring-1 focus:ring-orange-200 border-orange-100 rounded-md bg-stone-800 text-stone-50 focus:shadow-lg shadow-sm"
        />
      </div>
