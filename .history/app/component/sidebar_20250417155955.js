...
export default async function SideBar({ currentPage }) {
  ...
  return (
    <aside className="hidden relative md:fixed left-0 overflow-y-auto md:block border-r-2 dark:border-slate-800 border-x-slate-100 text-sm min-h-dvh p-4 max-w-sm ">
