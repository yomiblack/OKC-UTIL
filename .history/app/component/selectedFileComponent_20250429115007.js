...
export default function SelectedFileComponent({ useParams }) {
  const { id } = useParams?.fileSlug;
  ...
  // getFilebyId(currentPage);

  console.log("selected file:", getFileById);

  console.log("selected file2:", data);
