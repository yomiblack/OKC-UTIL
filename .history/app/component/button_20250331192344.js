...
export default function Button({
  ...
  return (
    <div className="group">
      <button
        className="isolate w-full transition-all duration-150 bg-red-600 text-white border-b-8 border-b-red-600 rounded-lg group-hover:border-t-8 group-hover:border-b-0 group-hover:border-t-red-600 group-hover:bg-red-600 group-hover:shadow-lg"
        type={type}
        onClick={onClick}
        disabled={disabled}
      >
