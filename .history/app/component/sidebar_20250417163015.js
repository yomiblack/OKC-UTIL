...
export default async function SideBar({ currentPage }) {
  ...
  const activeClass =
    "bg-gradient-to-r from-red-500 to-orange-400 bg-clip-text hover:from-red-600 hover:to-orange-500 hover:shadow-sm disabled:opacity-50";

  const inactiveClass = "hover:text-orange-300 hover:shadow-sm";
  ...
  return (
    <aside className="hidden relative md:fixed left-0 md:block border-r-2 dark:border-slate-800 border-slate-100 text-sm min-h-dvh p-4 max-w-sm ">
