...
export default function Header() {
  ...
  return (
    <header
      className={`${domine.className}  fixed top-0 left-0 right-0 w-full px-4 py-2 flex flex-col justify-center items-center space-y-5 md:flex-row md:justify-between md:space-y-0 shadow-md  dark:bg-slate-900 md:dark:shadow-slate-800 bg-gray-50 md:shadow-gray-200 md:z-10`}
    >
      <div className="flex items-center z-20 md:z-0">
        {/* Sidebar button */}
        {toggleSidebar && (
          <div
