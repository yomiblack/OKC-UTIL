  ...
  return (
    <div className={`${theme()} flex flex-col p-6 rounded-lg shadow-2xl`}>
      ...
      <div
        ...
        // className="flex flex-col justify-center md:justify-start items-center md:flex-row w-full md:w-fit md:space-x-4 space-y-4 md:space-y-0"
      >
        {/* <ProceedingsModal /> */}
