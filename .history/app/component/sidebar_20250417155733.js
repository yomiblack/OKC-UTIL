...
export default async function SideBar({ currentPage }) {
  ...
  return (
    <aside className="hidden relative md:fixed left-0 overflow-y-auto md:block border-r-2 border-slate-800 text-sm min-h-dvh p-4 max-w-sm text-slate-700 dark:text-slate-200">
