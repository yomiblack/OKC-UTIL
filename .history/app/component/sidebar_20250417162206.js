...
export default async function SideBar({ currentPage }) {
  ...
  return (
    <aside className="bg-gray-50 dark:bg-slate-900 text-slate-700 dark:text-slate-200 hidden relative md:fixed left-0 md:block border-r-2 dark:border-slate-800 border-slate-100 text-sm min-h-dvh p-4 max-w-sm ">
