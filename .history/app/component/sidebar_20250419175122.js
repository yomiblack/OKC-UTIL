    ...
    <aside className="">
      ...
      <div className="mb-6">
        <input
          ...
          className="bg-transparent w-full p-3 outline-none focus:outline-none focus:shadow-md focus:shadow-orange-300   rounded-md  dark:text-stone-50 text-stone-700 shadow-sm shadow-orange-200"
        />
      </div>
