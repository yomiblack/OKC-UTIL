    ...
    <aside className="">
      ...
      <div className="mb-6">
        <input
          ...
          className="bg-transparent w-full p-3 outline-none focus:outline-none focus:shadow-md shadow-orange-200  rounded-md  dark:text-stone-50 text-stone-700  shadow-sm"
        />
      </div>
