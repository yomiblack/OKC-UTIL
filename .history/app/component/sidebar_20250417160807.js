...
export default async function SideBar({ currentPage }) {
  ...
  return (
    <aside className="hidden relative md:fixed left-0 md:block border-r-2 dark:border-slate-800 border-r-slate-100 text-sm min-h-dvh p-4 max-w-sm ">
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full p-3 border focus:outline-none focus:ring-1 focus:ring-orange-400 border-orange-500 rounded-md bg-stone-800 text-stone-50"
        />
      </div>
