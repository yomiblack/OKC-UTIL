    ...
    <aside className="">
      ...
      <div className="mb-6">
        <input
          ...
          className="bg-transparent w-full p-3 border outline-none focus:outline-none focus:ring-1 focus:ring-orange-200  rounded-md  dark:text-stone-50 text-stone-700 focus:shadow-lg shadow-sm"
        />
      </div>
