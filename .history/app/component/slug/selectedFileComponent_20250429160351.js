...
export default function SelectedFileComponent({ currentPage }) {
  ...
  return (
    <div className={`${theme()} flex flex-col p-6 rounded-lg shadow-2xl`}>
      <menu className="flex gap-4 justify-between items-center ">
        <Link href="">
          <img
            src="/utils/edit.svg"
            alt="edit icon"
            className="w-6 h-6 bg-orange-700 hover:bg-orange-800 hover:shadow-lg rounded-full p-4 scale-110 transition-all duration-150"
          />
        </Link>
