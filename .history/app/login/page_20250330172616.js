        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-2 md:-mr-10">
            ...
            <input
              ...
              placeholder="Email"
              name="email"
              className="group peer p-1 px-4 border shadow-md dark:border-zinc-700 dark:bg-zinc-900 block bg-gray-200/20 text-slate-700 dark:text-gray-300 placeholder:text-xs placeholder:text-center placeholder:md:text-left text-center md:text-left focus:outline-none"
            />
            ...
            <div className=" relative">
              ...
              <Link href="/home">
                <DotLottieReact
                  ...
                  loop
                  autoplay
                  className="invisible group-placeholder-shown:visible h-8 w-8 absolute -right-8 top-1/2 transform -translate-y-1/2 cursor-pointer "
                />
              </Link>
            </div>
          </div>
