...
export default function LoginPage() {
  return (
    ...
    <div className="flex bg-gray-100 dark:bg-zinc-700 dark:text-white items-center justify-center min-h-dvh text-black">
      {/* Form container for the login page */}
      <div className="bg-gray-200 dark:bg-zinc-900 rounded-lg mx-6 px-10 py-8 md:py-0 shadow-md">
        {/* Flex container */}
