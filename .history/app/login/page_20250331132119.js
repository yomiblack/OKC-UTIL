...
export default function LoginPage() {
  return (
    ...
    <div className="flex bg-gray-50 dark:bg-zinc-800  items-center justify-center min-h-dvh">
      ...
      <div className="flex item-center justify-center min-w-fit bg-white dark:bg-zinc-900 rounded-lg mx-6 px-10 py-8 md:py-0 shadow-md">
        {/* Flex container */}
        <div className="flex flex-col md:flex-row items-center justify-center  md:space-x-20 md:px-6">
          ...
          {/* content */}
          <form className="">
            <h2 className="font-serif text-xl text-center md:text-left font-bold  text-gray-800 dark:text-gray-100 mb-8">
              Log In
            </h2>
            <input
              type="email"
