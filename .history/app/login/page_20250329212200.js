...
export default function LoginPage() {
  return (
    ...
    <div className="flex bg-white dark:bg-zinc-600 dark:text-white items-center justify-center h-screen text-black">
      {/* Form container for the login page */}
      <div className="bg-gray-300 dark:bg-zinc-700 rounded-lg mx-6">
        {/* Flex container */}
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-4 p-8">
            ...
            <input type="email" className=" border block text-black" />
            <div className=" relative">
              <input type="password" className="border text-black" />
              <img
                src="/login/arrow.svg"
                alt="login arrow"
