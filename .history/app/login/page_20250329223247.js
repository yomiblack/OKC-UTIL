        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-4 p-8">
            ...
            <input
              type="email"
              placeholder="Email"
              className="p-1 px-4 border border-zinc-600 bg-zinc-800 block text-white placeholder:text-xs placeholder:text-center placeholder:md:text-left text-center md:text-left"
            />
