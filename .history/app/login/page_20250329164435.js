      ...
      <div className="bg-gray-300 dark:bg-zinc-800 rounded-lg mx-6">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <Image
            ...
            // fill
            priority
            className="flex flex-1 items-center justify-start object-contain h-64 md:h-80"
          />
          {/* content */}
          <div className="flex flex-col flex-1 items-center justify-center space-y-4 pb-6">
