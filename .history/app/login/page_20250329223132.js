          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-4 p-8">
            ...
            <div className=" relative">
              <input
                ...
                className="p-1 px-4 border border-zinc-600 bg-zinc-800 text-white placeholder:text-xs placeholder:text-center placeholder:md:text-left text-center md:text-left"
              />
              <img
                src="/login/arrow.svg"
                alt="login arrow"
