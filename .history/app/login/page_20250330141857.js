        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-2 md:-mr-10">
            ...
            <input
              type="email"
              placeholder="Email"
              className="peer p-1 px-4 border shadow-md dark:border-zinc-700 dark:bg-zinc-900 block bg-gray-200/20 text-gray-300 placeholder:text-xs placeholder:text-center placeholder:md:text-left text-center md:text-left focus:outline-none"
            />
