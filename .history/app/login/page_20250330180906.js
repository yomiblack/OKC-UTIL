...
export default function LoginPage() {
  return (
    ...
    <form className="flex bg-gray-50 dark:bg-zinc-700  items-center justify-center min-h-dvh">
      ...
      <div className="flex item-center justify-center w-full bg-gray-200/20 dark:bg-zinc-900 rounded-lg mx-6 px-10 py-8 md:py-0 shadow-md">
        {/* Flex container */}
        <div className="flex flex-col md:flex-row">
          ...
          <Image
            ...
            height={300}
            priority
            className="object-contain h-64 md:h-80 -mb-10 -mt-16 md:-mt-0 md:-ml-24"
          />
          {/* content */}
          <div className="flex flex-col items-center justify-center space-y-2 md:-mr-10">
