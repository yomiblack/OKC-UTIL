...
export default function LoginPage() {
  return (
    ...
    <div className="flex bg-white dark:bg-zinc-800 dark:text-white items-center justify-center min-h-dvh text-black">
      {/* Form container for the login page */}
      <div className="bg-gray-300 dark:bg-zinc-900 rounded-lg mx-6 px-10 py-8 md:py-0">
        {/* Flex container */}
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-2 md:-mr-10">
            ...
            <input
              type="email"
              placeholder="Email"
              className="peer p-1 px-4 border dark:border-zinc-700 dark:bg-zinc-900 block dark:text-white placeholder:text-xs placeholder:text-center placeholder:md:text-left text-center md:text-left focus:outline-none"
            />
