            ...
            <div className=" relative">
              ...
              <Link href="/home">
                <DotLottieReact
                  ...
                  loop
                  autoplay
                  className="h-8 w-8 absolute -right-8 top-1/2 transform -translate-y-1/2 cursor-pointer hover:animate-bounce hover:scale-110 transition-transform duration-300"
                />
              </Link>
            </div>
          </div>
