...
export default function LoginPage() {
  return (
    ...
    <div className="flex bg-white dark:bg-zinc-700 dark:text-white items-center justify-center min-h-dvh text-black">
      ...
      <div className="bg-gray-300 dark:bg-zinc-800 rounded-lg mx-6 px-8">
        {/* Flex container */}
        <div className="flex flex-col md:flex-row">
          ...
          />
          {/* content */}
          <div className="flex flex-col flex-1 items-center justify-center space-y-2 md:-mr-10 py-8 md:py-0">
