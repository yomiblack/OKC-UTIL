      ...
      <div className="flex item-center justify-center min-w-fit bg-gray-200/20 dark:bg-zinc-900 rounded-lg mx-6 px-10 py-8 md:py-0 shadow-md">
        ...
        <div className="flex flex-col md:flex-row md:space-x-20 md:px-6">
          ...
          <form className="flex flex-col items-center justify-center space-y-1">
            <h2 className="font-serif text-xl font-bold md:text-left text-gray-800 dark:text-gray-100 mb-2">
              Log In
            </h2>
            <input
              type="email"
            ...
            <Link href={`/forgotpassword`}>
              <div className="group flex items-start justify-start space-x-3">
