    ...
    <div className="flex bg-gray-50 dark:bg-zinc-800  items-center justify-center min-h-dvh">
      ...
      <div className="flex item-center justify-center min-w-fit bg-gray-200/20 dark:bg-zinc-900 rounded-lg mx-6 px-10 py-8 md:py-0 shadow-md">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center  md:space-x-20 md:px-6">
          ...
          {/* content */}
          <form className="">
            <h2 className="font-serif text-xl text-center md:text-left font-bold  text-gray-800 dark:text-gray-100 mb-2">
              Log In
            </h2>
            <input
              type="email"
            ...
            <Link href={`/forgotpassword`}>
              <div className="group flex items-center space-x-3 mt-10">
                <div className="w-3 h-3 bg-orange-400 rounded-full group-hover:animate-ping"></div>
                <div className="text-xs text-gray-300">Forgot password?</div>
              </div>
            </Link>
          </form>
        </div>
