        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-4 p-8">
            ...
            <input
              type="email"
              placeholder="Email"
              className="p-1 px-4 border border-zinc-600 bg-zinc-800 block text-white text-center md:text-left placeholder:text-xs"
            />
            <div className=" relative">
              <input
                type="password"
                placeholder="Password"
                className="p-1 px-4 border border-zinc-600 bg-zinc-800 text-white text-center md:text-left placeholder:text-xs"
              />
              <img
                src="/login/arrow.svg"
                alt="login arrow"
