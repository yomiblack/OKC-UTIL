...
export default function LoginPage() {
  return (
    ...
    <div className="flex bg-gray-50 dark:bg-zinc-700 dark:text-white items-center justify-center min-h-dvh text-black">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 items-center justify-center space-y-2 md:-mr-10">
            ...
            <input
              type="email"
              placeholder="Email"
              className="peer p-1 px-4 border shadow-md dark:border-zinc-700 dark:bg-zinc-900 block bg-gray-200/20 text-slate-600 dark:text-gray-300 placeholder:text-xs placeholder:text-center placeholder:md:text-left text-center md:text-left focus:outline-none"
            />
